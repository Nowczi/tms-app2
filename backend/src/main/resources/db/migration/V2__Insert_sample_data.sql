-- ========================================================-- TMS Database Sample Data-- Flyway Migration V2 - Sample Data Insertion-- ========================================================-- =====================================================-- USERS-- =====================================================
...
-- =====================================================-- DOCUMENTS (Sample with UUIDs)-- =====================================================
INSERT INTO documents (id, file_name, file_url, file_type, file_size, entity_type, entity_id, uploaded_by, uploaded_at)
VALUES 
    ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'umowa_przewozu_001.pdf', '/documents/contracts/umowa_przewozu_001.pdf', 'application/pdf', 245760, 'ORDER', 1, 'admin', CURRENT_TIMESTAMP - INTERVAL '7 days'),
    ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12', 'faktura_001.pdf', '/documents/invoices/faktura_001.pdf', 'application/pdf', 125952, 'ORDER', 1, 'admin', CURRENT_TIMESTAMP - INTERVAL '5 days');

-- =====================================================-- ORDER DOCUMENTS (Standalone entity)-- =====================================================
INSERT INTO order_documents (order_id, file_name, file_url, file_type, uploaded_by, uploaded_at)
VALUES 
    (1, 'pod_zdjecie_001.jpg', '/documents/pod/pod_zdjecie_001.jpg', 'image/jpeg', 'driver1', CURRENT_TIMESTAMP - INTERVAL '5 days'),
    (2, 'pod_zdjecie_002.jpg', '/documents/pod/pod_zdjecie_002.jpg', 'image/jpeg', 'driver2', CURRENT_TIMESTAMP - INTERVAL '3 days');
